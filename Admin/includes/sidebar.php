 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
     <a class="sidebar-brand d-flex align-items-center bg-gradient-primary  justify-content-center" href="index.php">
         ...
         <img src="img/logo/northern.png" style="width:60px;height:60px">
         </div>
         <div class="sidebar-brand-text mx-3">NUB Attendance</div>
     </a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Manage Semester</h6>
                 <a class="collapse-item" href="createClass.php">Create Semester</a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Assign Course Teachers</h6>
                 <a class="collapse-item" href="createClassTeacher.php">Assign Course Teachers</a>
     ...
     <li class="nav-item">
         <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap2" aria-expanded="true" aria-controls="collapseBootstrap2">
             ...
             <span>Manage Students Profile</span>
         </a>
         <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Manage Students Profile</h6>
                 <a class="collapse-item" href="createStudents.php">Create Students Profile</a>
