              ...
              <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                ...
                <form class="navbar-search">
                  <div class="input-group">
                    <input type="text" class="form-control bg-light border-1 small" placeholder="look for?"
                      aria-label="Search" aria-describedby="basic-addon2" style="border-color:rgb(22, 35, 214);">
